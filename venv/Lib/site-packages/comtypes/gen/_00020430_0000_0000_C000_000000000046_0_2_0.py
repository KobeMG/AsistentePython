...
IFontDisp = Font
__all__ = [ 'LoadPictureConstants', 'FONTNAME', 'Checked', 'FONTBOLD',
           'OLE_YSIZE_PIXELS', 'IFontEventsDisp', 'Color', 'VgaColor',
           'IFont', 'OLE_CANCELBOOL', 'OLE_YSIZE_CONTAINER',
           'Picture', 'OLE_COLOR', 'Gray', 'FONTUNDERSCORE',
           'Unchecked', 'OLE_TRISTATE', 'OLE_XPOS_CONTAINER',
           'StdFont', 'Font', 'OLE_XSIZE_CONTAINER', 'IPictureDisp',
           'OLE_XSIZE_PIXELS', 'StdPicture', 'OLE_HANDLE',
           'OLE_YPOS_PIXELS', 'FONTSTRIKETHROUGH',
           'OLE_XSIZE_HIMETRIC', 'FontEvents', 'Default',
           'OLE_YPOS_HIMETRIC', 'Monochrome', 'OLE_YSIZE_HIMETRIC',
           'IFontDisp', 'IPicture', 'OLE_XPOS_PIXELS',
           'OLE_YPOS_CONTAINER', 'OLE_OPTEXCLUSIVE',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XPOS_HIMETRIC', 'FONTITALIC',
           'FONTSIZE']
